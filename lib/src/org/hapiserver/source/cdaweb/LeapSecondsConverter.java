...
/**
 * TT2000 converter that takes leap seconds into account from us2000.  This was borrowed from https://github.com/das-developers/das2java.
 * @author jbf
 */
public class LeapSecondsConverter {

    private static Logger logger= Logger.getLogger("das2.datum.uc");
    ...
    private static void updateLeapSeconds() throws IOException, MalformedURLException, NumberFormatException {
        ...
        try (BufferedReader r = new BufferedReader(new InputStreamReader(in))) {
            ...
            while ( true ) {  
                ...
                double us2000 = ( TimeUtil.julianDay( iyear, imonth, iday ) - 2451545 ) * 86400000000.;
    ...
    /**
     * convert the value from tt2000 to us2000, or vise-versa.
     * @param value
     * @return 
     */
